          ...
          {step === "choose" && (
            <div className="flex flex-col gap-4 w-full max-w-md">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-6 py-3 bg-slate-800 text-white rounded-lg shadow hover:bg-slate-900 active:bg-black transition font-bold cursor-pointer ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                disabled={loading}
              >
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#FFD700] text-black rounded-lg shadow  focus:outline-none focus:ring-2  focus:ring-offset-2 font-bold cursor-pointer ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                disabled={loading}
              >
                <FcGoogle className="h-5 w-5" />
